"""
Base Django settings for allinonenepal project.
...
REST_FRAMEWORK = {
    ...
    'PAGE_SIZE': 20,
    'EXCEPTION_HANDLER': 'core.common.responses.handlers.global_exception_handler',
}
...
# Backward compatibility for 3rd party packages (like Cloudinary)
